...
export const redHanger = new Node('red')
...
const boardSpace21 = new Node('red')
const boardSpace22 = new Node('yellow')
const boardSpace23 = new Node('blue')
const boardSpace24 = new Node('green')
const boardSpace25 = new Node('red')
const boardSpace26 = new Node('yellow')
const boardSpace27 = new Node('blue')
const boardSpace28 = new Node('green')
const boardSpace29 = new Node('red')
const boardSpace30 = new Node('yellow')
const boardSpace31 = new Node('blue')
const boardSpace32 = new Node('green')
const boardSpace33 = new Node('red')
const boardSpace34 = new Node('yellow')
const boardSpace35 = new Node('blue')
const boardSpace36 = new Node('green')
const boardSpace37 = new Node('red')
const boardSpace38 = new Node('yellow')
const boardSpace39 = new Node('blue')
const boardSpace40 = new Node('green')
const boardSpace41 = new Node('red')
const boardSpace42 = new Node('yellow')
const boardSpace43 = new Node('blue')
const boardSpace44 = new Node('green')
const boardSpace45 = new Node('red')
const boardSpace46 = new Node('yellow')
const boardSpace47 = new Node('blue')
const boardSpace48 = new Node('green')
const boardSpace49 = new Node('red')
const boardSpace50 = new Node('yellow')
const boardSpace51 = new Node('blue')
const boardSpace52 = new Node('green')

const redLadder1 = new Node('red')
const redLadder2 = new Node('red')
const redLadder3 = new Node('red')
const redLadder4 = new Node('red')
const redLadder5 = new Node('red')
const redLadder6 = new Node('red')

const yellowLadder1 = new Node('yellow')
const yellowLadder2 = new Node('yellow')
const yellowLadder3 = new Node('yellow')
const yellowLadder4 = new Node('yellow')
const yellowLadder5 = new Node('yellow')
const yellowLadder6 = new Node('yellow')

const blueLadder1 = new Node('blue')
const blueLadder2 = new Node('blue')
const blueLadder3 = new Node('blue')
const blueLadder4 = new Node('blue')
const blueLadder5 = new Node('blue')
const blueLadder6 = new Node('blue')

const greenLadder1 = new Node('green')
const greenLadder2 = new Node('green')
const greenLadder3 = new Node('green')
const greenLadder4 = new Node('green')
const greenLadder5 = new Node('green')
const greenLadder6 = new Node('green')
...
redHanger.next = boardSpace1
yellowHanger.next = boardSpace14
blueHanger.next = boardSpace27
greenHanger.next = boardSpace40